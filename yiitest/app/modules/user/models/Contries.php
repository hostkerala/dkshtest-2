 ...
 */
class Contries extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Contries the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, country_iso_2, country_iso_3, country_name_en, country_name_ru', 'safe', 'on' => 'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('country_iso_2', $this->country_iso_2, true);
		$criteria->compare('country_iso_3', $this->country_iso_3, true);
