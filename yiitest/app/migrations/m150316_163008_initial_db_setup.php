...
class m150316_163008_initial_db_setup extends CDbMigration
{
	public function up()
	{
		$sql = <<<SQL
                ...
                CREATE SCHEMA IF NOT EXISTS `17191726_0000001` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
                USE `17191726_0000001` ;

                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`categories`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`categories` (
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`countries`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`countries` (
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`states`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`states` (
                  `id` INT(11) NOT NULL AUTO_INCREMENT,
                  ...
                  CONSTRAINT `fk_states_countries1`
                    ...
                    REFERENCES `17191726_0000001`.`countries` (`id`)
                    ON DELETE NO ACTION
                    ON UPDATE NO ACTION)
                ENGINE = InnoDB
                AUTO_INCREMENT = 1
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`user`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`user` (
                  `id` INT(11) NOT NULL AUTO_INCREMENT,
                  ...
                  CONSTRAINT `fk_user_zipareas2`
                    FOREIGN KEY (`city_id`)
                    REFERENCES `17191726_0000001`.`zipareas` (`id`)
                    ON DELETE NO ACTION
                    ON UPDATE NO ACTION,
                  CONSTRAINT `fk_user_states1`
                    FOREIGN KEY (`state_id`)
                    REFERENCES `17191726_0000001`.`states` (`id`)
                    ON DELETE NO ACTION
                    ON UPDATE NO ACTION)
                ENGINE = InnoDB
                AUTO_INCREMENT = 1
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`config`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`config` (
                  `id` INT(11) NOT NULL AUTO_INCREMENT,
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`skill`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`skill` (
                  `id` INT(11) NOT NULL AUTO_INCREMENT,
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`rel_user_skills`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`rel_user_skills` (
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`rel_topic_category`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`rel_topic_category` (
                  ...
                  CONSTRAINT `fk_categories_has_topic_categories1`
                    ...
                    REFERENCES `17191726_0000001`.`categories` (`id`)
                    ON DELETE NO ACTION
                    ON UPDATE NO ACTION,
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`rel_topic_skills`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`rel_topic_skills` (
                  `skill_id` INT(11) NOT NULL,
                  `topic_id` INT NOT NULL,
                  ...
                  CONSTRAINT `fk_skill_has_topic_skill1`
                    ...
                    REFERENCES `17191726_0000001`.`skill` (`id`)
                    ON DELETE NO ACTION
                    ON UPDATE NO ACTION,
                ...
                -- -----------------------------------------------------
                -- Table `17191726_0000001`.`pages`
                -- -----------------------------------------------------
                CREATE TABLE IF NOT EXISTS `17191726_0000001`.`pages` (
                  `id` INT NOT NULL AUTO_INCREMENT,
